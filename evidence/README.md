...
| [`05_live_llm_discovery_PENDING/`](05_live_llm_discovery_PENDING/) | Genuine LLM-driven discovery | — | **pending** — not yet performed |
...
own `_note` field. Scenarios 03/04 rely on the real event log and
